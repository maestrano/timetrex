...
ALTER TABLE company_deduction ADD COLUMN pay_stub_entry_description varchar(250);

ALTER TABLE pay_stub_amendment ADD COLUMN private_description varchar(250);
