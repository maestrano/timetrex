...
DROP INDEX user_date_total_id ON user_date_total_old;
DROP INDEX user_date_total_user_date_id ON user_date_total_old;
...
CREATE TABLE user_date_total (
	...
	quantity numeric(9,2) DEFAULT 0 NOT NULL,
	bad_quantity numeric(9,2) DEFAULT 0 NOT NULL,
...
CREATE INDEX user_date_total_user_id_user_date ON user_date_total(user_id, date_stamp);
CREATE INDEX user_date_total_object_type_id ON user_date_total(object_type_id);
...
(
	...
	CASE WHEN ( UNIX_TIMESTAMP( end_time_stamp ) - UNIX_TIMESTAMP( start_time_stamp ) ) > 0 THEN ( UNIX_TIMESTAMP( end_time_stamp ) - UNIX_TIMESTAMP( start_time_stamp) ) ELSE 0 END as total_time,
	CASE WHEN ( UNIX_TIMESTAMP( end_time_stamp ) - UNIX_TIMESTAMP( start_time_stamp ) ) > 0 THEN ( UNIX_TIMESTAMP( end_time_stamp ) - UNIX_TIMESTAMP( start_time_stamp) ) ELSE 0 END as actual_total_time,
...
CREATE INDEX user_date_total_pay_code_id ON user_date_total(pay_code_id);
CREATE INDEX user_date_total_pay_period_id ON user_date_total(pay_period_id);
CREATE INDEX user_date_total_branch_id ON user_date_total(branch_id);
CREATE INDEX user_date_total_department_id ON user_date_total(department_id);
CREATE INDEX user_date_total_job_id ON user_date_total(job_id);
CREATE INDEX user_date_total_job_item_id ON user_date_total(job_item_id);


ALTER TABLE punch_control RENAME TO punch_control_old;
DROP INDEX punch_control_id ON punch_control_old;
DROP INDEX punch_control_user_date_id ON punch_control_old;
...
CREATE INDEX punch_control_user_id_user_date ON punch_control(user_id, date_stamp);
CREATE INDEX punch_control_pay_period_id ON punch_control(pay_period_id);
CREATE INDEX punch_control_branch_id ON punch_control(branch_id);
CREATE INDEX punch_control_department_id ON punch_control(department_id);
CREATE INDEX punch_control_job_id ON punch_control(job_id);
CREATE INDEX punch_control_job_item_id ON punch_control(job_item_id);


ALTER TABLE schedule RENAME TO schedule_old;
DROP INDEX schedule_id ON schedule_old;
DROP INDEX schedule_company_id ON schedule_old;
DROP INDEX schedule_recurring_schedule_template_control_id ON schedule_old;
DROP INDEX schedule_start_time_end_time ON schedule_old;
DROP INDEX schedule_user_date_id ON schedule_old;
...
CREATE INDEX schedule_user_id_user_date ON schedule(user_id, date_stamp);
CREATE INDEX schedule_pay_period_id ON schedule(pay_period_id);
CREATE INDEX schedule_company_id ON schedule(company_id);
CREATE INDEX schedule_branch_id ON schedule(branch_id);
CREATE INDEX schedule_department_id ON schedule(department_id);
CREATE INDEX schedule_job_id ON schedule(job_id);
CREATE INDEX schedule_job_item_id ON schedule(job_item_id);
CREATE INDEX schedule_company_recurring_schedule_template_control_id ON schedule(recurring_schedule_template_control_id);


ALTER TABLE exception RENAME TO exception_old;
DROP INDEX exception_id ON exception_old;
DROP INDEX exception_user_date_id ON exception_old;
...
CREATE INDEX exception_user_id_user_date ON exception(user_id, date_stamp);
CREATE INDEX exception_pay_period_id ON exception(pay_period_id);



ALTER TABLE request RENAME TO request_old;
DROP INDEX request_id ON request_old;
DROP INDEX request_status_id_authorized ON request_old;
DROP INDEX request_user_date_id ON request_old;
...
CREATE INDEX request_user_id_user_date ON request(user_id, date_stamp);
CREATE INDEX request_pay_period_id ON request(pay_period_id);
CREATE INDEX request_type_id ON request(type_id);
CREATE INDEX request_status_id ON request(status_id);
