...
CREATE TABLE pay_formula_policy (
	...
	rate numeric(9,4),
	custom_formula varchar(250) NULL,
...
ALTER TABLE meal_policy ADD COLUMN description varchar(250);
ALTER TABLE break_policy ADD COLUMN description varchar(250);
ALTER TABLE holiday_policy ADD COLUMN description varchar(250);
ALTER TABLE exception_policy_control ADD COLUMN description varchar(250);
ALTER TABLE schedule_policy ADD COLUMN description varchar(250);
ALTER TABLE over_time_policy ADD COLUMN description varchar(250);
ALTER TABLE premium_policy ADD COLUMN description varchar(250);
ALTER TABLE absence_policy ADD COLUMN description varchar(250);
ALTER TABLE accrual_policy ADD COLUMN description varchar(250);
ALTER TABLE round_interval_policy ADD COLUMN description varchar(250);
ALTER TABLE policy_group ADD COLUMN description varchar(250);

ALTER TABLE accrual ADD COLUMN note varchar(250);
...
UPDATE accrual set type_id = 76 WHERE id in ( SELECT * FROM ( SELECT a.id from accrual as a LEFT JOIN accrual_policy as b ON ( a.accrual_policy_id = b.id ) WHERE a.type_id = 75 AND b.type_id = 30 ) as x );

ALTER TABLE accrual CHANGE accrual_policy_id accrual_policy_account_id integer;
...
ALTER TABLE accrual_balance CHANGE accrual_policy_id accrual_policy_account_id integer;
