...
CREATE UNIQUE INDEX message_recipient_id ON message_recipient(id);
CREATE UNIQUE INDEX message_sender_id ON message_sender(id);
CREATE UNIQUE INDEX message_control_id ON message_control(id);
CREATE UNIQUE INDEX system_log_detail_id ON system_log_detail(id);
CREATE UNIQUE INDEX company_generic_tag_map_id ON company_generic_tag_map(id);


ALTER TABLE company_deduction CHANGE company_value1 company_value1 text;
ALTER TABLE company_deduction CHANGE company_value2 company_value2 text;
