...
// +----------------------------------------------------------------------+
//
// $Id: Encoding.php,v 1.1 2004/12/06 15:12:56 mike Exp $
...
class I18Nv2_Encoding
{
     ...
     */
    static function standardize($encoding)
    {
     ...
     * @param   string  $encoding
     */
    static function isEncoding($encoding)
    {
     ...
     * @param   string  $encoding
     */
    static function isAlias($encoding)
    {
     ...
     * @param   string  $encoding
     */
    static function exists($encoding)
    {
     ...
     * @param   string      $encoding
     */
    static function nameOf($encoding)
    {
     ...
     * @param   string  $encoding
     */
    static function aliasesOf($encoding)
    {
        $name = I18Nv2_Encoding::standardize($encoding);
     ...
     * @param   string  $alias
     */
    static function forAlias($alias)
    {
