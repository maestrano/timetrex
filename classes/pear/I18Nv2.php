...
// +----------------------------------------------------------------------+
//
// $Id: I18Nv2.php,v 1.36 2006/03/08 13:07:18 mike Exp $
...
class I18Nv2
{
     ...
     * @param   string  $part
     */
    static function getInfo($part = null)
    {
        $info = &I18Nv2::getStaticProperty('info');
     ...
     */
    static function &createLocale($locale = null, $paranoid = false)
    {
     ...
     */
    static function &createNegotiator($defLang = 'en', $defEnc = 'iso-8859-1', $defCtry = '')
    {
     ...
     *                                  ob_iconvhandler
     */
    static function autoConv($oe = 'UTF-8', $ie = 'ISO-8859-1', $decodeRequest = true, $refetchOB = true)
    {
        if (!strcasecmp($oe, $ie)) {
            return true;
        }
     ...
     * @param   string  $to
     */
    static function recursiveIconv(&$value, $from, $to)
    {
     ...
     * @param   array   $locales
     */
    static function locales2langs($locales)
    {
     ...
     */
    static function langs2locales($languages)
    {
     ...
     */
    static function l2l($localeOrLanguage)
    {
     ...
     * @param   string  $locale
     */
    static function splitLocale($locale)
    {
     ...
     */
    static function languageOf($locale)
    {
     ...
     * @param   string  $locale
     */
    static function countryOf($locale)
    {
