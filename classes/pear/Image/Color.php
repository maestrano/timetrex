...
class Image_Color
{
     ...
     *                  class.
     */
    static function mixColors($col1 = false, $col2 = false)
    {
        if ($col1) {
     ...
     * @author  Jason Lotito <jason@lehighweb.com>
     */
    static function setColors($col1, $col2)
    {
        self::_setColors($col1, $col2);
    }
     ...
     */
    static function getRange($degrees = 2)
    {
        if ($degrees == 0) {
            $degrees = 1;
        }
     ...
     */
    static function changeLightness($degree = 10)
    {
        $color1 = self::$color1;
        $color2 = self::$color2;
