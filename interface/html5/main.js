...
//				if ( LocalCacheData.isSupportHTML5LocalCache ) {
//					var is_refresh = sessionStorage.getItem( "is_reloaded" );
//
//					if ( !is_refresh ) {
//						$.cookie( 'KevinTest', 2, {expires: 30, path: LocalCacheData.cookie_path} );
//					} else
//						$.cookie( 'KevinTest', 1, {expires: 30, path: LocalCacheData.cookie_path} );
//				}
//			}

//			window.onbeforeunload = function( evt ) {
//
//				var message = $.i18n._( 'You are leaving' ) + ' ' + LocalCacheData.getLoginData().application_name + ' ' +
//					$.i18n._( 'without logging out first, would you like to logout of your' ) + ' ' +
//					LocalCacheData.getLoginData().application_name + ' ' + $.i18n._( 'session now?' );
//
