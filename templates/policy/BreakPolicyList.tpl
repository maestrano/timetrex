...
<div id="rowContentInner">
		...
		<form method="get" action="{$smarty.server.SCRIPT_NAME}">
				...
				<tr class="tblHeader">
					...
					<td>
						{capture assign=label}{t}Break Time{/t}{/capture}
				...
				{foreach from=$policies name=policies item=policy}
					...
					<tr class="{$row_class}">
						...
						<td>
							...
							{if $permission->Check('break_policy','edit')}
								[ <a href="{urlbuilder script="EditBreakPolicy.php" values="id=$policy_id" merge="FALSE"}">{t}Edit{/t}</a> ]
							{/if}
						</td>
						<td>
