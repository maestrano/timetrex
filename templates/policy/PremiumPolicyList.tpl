				...
				{foreach from=$policies name=policies item=policy}
					...
					<tr class="{$row_class}">
						...
						<td>
							...
							{if $permission->Check('premium_policy','edit')}
								[ <a href="{urlbuilder script="EditPremiumPolicy.php" values="id=$policy_id" merge="FALSE"}">{t}Edit{/t}</a> ]
							{/if}
						</td>
						<td>
